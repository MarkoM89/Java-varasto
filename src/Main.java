		    		...
		    		System.out.print("\nToiminto 1: Lis‰‰ tuote\nToiminto 2: Poista tuote\nToiminto 3: Tulosta tuotteet\n"
		            		...
		            		case 1:
		            			...
		            			try (Connection conn = DriverManager.getConnection("jdbc:mariadb://127.0.0.1:3306/kokeilutietokanta", connConfig)) {
		    		             	PreparedStatement stmt = conn.prepareStatement("INSERT INTO tuote (tuotenimi, yksikkˆhinta) VALUES (?, ?)");
		    				...
		    				case 2:
		    	    			...
		    	    			System.out.println("Mik‰ tuote poistetaan? syˆt‰ luku 0, jos et halua poistaa mit‰‰n");
				    	            ...
				    	            try (Statement stmt = conn.createStatement()) {
				    	                try (ResultSet tuotetiedot = stmt.executeQuery("SELECT * FROM tuote")) {
				    	                    while (tuotetiedot.next()) {
				    	                    	...
				    	                    	System.out.println(tuotetiedot.getString("tuotetunniste")+ " " +tuotetiedot.getString("tuotenimi")+ " " +tuotetiedot.getString("yksikkˆhinta")+ "Ä");
				    	                    }
				    	                }
				    	            }
				    	        } catch (Exception e) {
